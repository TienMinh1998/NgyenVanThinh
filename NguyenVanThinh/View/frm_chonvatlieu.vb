            ...
            Else
                If IsNumeric(txt_chieudaysan.Text) Then
                    If IsNumeric(txt_lopbaove.Text) Then
                        ...
                        'MessageBox.Show("Chọn vật liệu thành công", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        A_frm_main.Instance.VatlieuState = True
                        Me.Close()
                    Else
                        txt_lopbaove.Focus()
